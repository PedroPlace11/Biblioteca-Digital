                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="py-2">
                                        <div class="flex items-center gap-3">
                                            @php
                                                $user = $requisicao->user ?? null;
                                                $foto = ($user && $user->profile_photo_path) ? asset('storage/'.$user->profile_photo_path) : ($user ? $user->profile_photo_url : '');
                                            @endphp
                                            <img src="{{ $foto }}" alt="{{ $requisicao->cidadao_nome ?? $user?->name ?? 'Cidadão' }}" class="w-10 h-10 rounded-full object-cover border border-gray-200 shrink-0">
                                            <div>
